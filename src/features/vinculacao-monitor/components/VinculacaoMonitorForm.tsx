...
import InputVinculacao from "./InputVinculacao";
import { useVinculacaoMonitor } from "../hooks/useVinculacaoMonitor";
              ...
              <div className="grid gap-2 p-2 sm:p-4 items-center">
                <div className="flex flex-col sm:flex-row">
                  <ul className="mt-2 space-y-4 sm:space-y-5 text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed w-full">
                    <li>
                      <strong>1.</strong> Acesse o link do monitor:{" "}
                      <a href="https://example.com/rastreio" className="text-blue-600 hover:underline break-all sm:break-words">
                        https://example.com/monitor-fila
                      </a>
                    </li>
                    <li>
                      <strong>2.</strong> Insira seu CPF ou CNPJ no campo de texto do <strong>monitor</strong>.
                    </li>
