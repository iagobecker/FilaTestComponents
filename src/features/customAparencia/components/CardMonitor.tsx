...
export default function CardMonitor({
  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-[680px] mx-auto p-1 ">
              ...
              <div className="w-2/3">
                ...
                <div className="space-y-2 rounded-lg h-full" style={{ backgroundColor: "rgba(255, 255, 255, 0.3)" }}>
                  <CardContent className="pb-3 pt-3 flex items-center">
                    ...
                    <p className="text-sm font-medium text-white flex-1  pl-3" style={{ color: overlayColor }}>IAGO BECKER</p>
                  </CardContent>
      ...
      {/* App do Usuário - Versão Compacta */}
            ...
            <div className="p-2 h-full flex flex-col">
              ...
              <div className="flex flex-col items-center mb-2">
                {companyLogo ? (
                  <img
                    src={companyLogo}
                    className="size-8 rounded-full object-contain mb-1"
                    alt="Logo"
                  />
                ) : (
              ...
              <div className="flex justify-center mt-1">
                <button className="flex items-center text-[10px] text-gray-600 hover:text-gray-800">
                  <Upload className="w-2.5 h-2.5 rotate-90 mr-1" />
                  Desistir da fila
                </button>
              </div>
            </div>
